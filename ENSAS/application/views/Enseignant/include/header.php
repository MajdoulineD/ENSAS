    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="/ENSAS/EnseignantController">ENSA SAFI</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a class="page-scroll" href="/ENSAS/EnseignantController/Emploi">Emploi du temps</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/ENSAS/EnseignantController/AddAbsence">Add Absence</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/ENSAS/EnseignantController/AddRattrapage">Add Rattrapage</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/ENSAS/EnseignantController/ContactUs">Contact</a>
                    </li>
                    <li>
